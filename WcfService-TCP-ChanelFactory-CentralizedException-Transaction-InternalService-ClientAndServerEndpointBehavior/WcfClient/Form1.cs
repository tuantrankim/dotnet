...
namespace WcfClient
{
    public partial class Form1 : Form
    {
        ...
        const String ServiceEndpoint = "net.tcp://localhost:7777/EmployeeService";
        ...
        private void btnInternalService_Click(object sender, EventArgs e)
        {
            try
            {
                var emp = sw.Channel.GetEmployeeInternal(Convert.ToInt32(txtID.Text));
                if (emp != null)
                {
                    txtName.Text = emp.Name;
                    txtGender.Text = emp.Gender;
        ...
        private void btnClientBehavior_Click(object sender, EventArgs e)
        {
            try
            {
                var emp = sw.Channel.GetEmployee(Convert.ToInt32(txtID.Text));
